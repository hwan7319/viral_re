...
| 디너의여왕 | campaign list | benefit and mission | list `N일 남음` application countdown | list when published |
...
| 모블 | public list | detail refresh | list `오늘마감` / `내일마감` / `N일 남음` | list when published |
