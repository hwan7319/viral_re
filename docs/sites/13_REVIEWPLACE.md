# Site Audit Document: 13. 리뷰플레이스

## 1. 개요 (Overview)
- **사이트명**: 13. 리뷰플레이스
- **공식 도메인**: `https://www.reviewplace.co.kr`
- **주요 수집 대상**: 대형 리뷰 마케팅 플랫폼 (지역 맛집, 배송형 혜택 특화)
- **연동 파이프라인**:
...
- **Target URL**: `https://www.reviewplace.co.kr`
- **HTTP Header 필수 조건**:
...
- **DOM Selector**:
  ...
  - 고유 ID 규격: `리뷰플레이스-${cpId}`

## 3. 검증 결과 및 이슈 해결 트러블슈팅 (Troubleshooting)
- **도메인 최신화**: 공식 도메인 `https://www.reviewplace.co.kr` 접속 상태 HTTP 200 OK 확인 완료.
