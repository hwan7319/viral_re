# Site Audit Document: 16. 체험단천국

## 1. 개요 (Overview)
- **사이트명**: 16. 체험단천국
- **공식 도메인**: `https://ch-heaven.co.kr`
- **주요 수집 대상**: 방문형, 배송형 종합 마케팅 체험단
- **연동 파이프라인**:
...
- **Target URL**: `https://ch-heaven.co.kr`
- **HTTP Header 필수 조건**:
...
- **도메인 최신화**: 공식 도메인 `https://ch-heaven.co.kr` 접속 상태 HTTP 200 OK 확인 완료.
