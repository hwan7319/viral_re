# Site Audit Document: 10. 놀러와체험단

## 1. 개요 (Overview)
- **사이트명**: 10. 놀러와체험단
- **공식 도메인**: `https://www.cometoplay.kr`
- **주요 수집 대상**: 풀빌라, 펜션, 지역 맛집, 소갈비/소고기 방문형 특화 체험단
- **연동 파이프라인**:
...
- **Target URL**: `https://www.cometoplay.kr`
- **HTTP Header 필수 조건**:
...
- **DOM Selector**:
  ...
  - 고유 ID 규격: `놀러와체험단-${cpId}`

## 3. 검증 결과 및 이슈 해결 트러블슈팅 (Troubleshooting)
- **도메인 최신화**: 공식 도메인 `https://www.cometoplay.kr` 접속 상태 HTTP 200 OK 확인 완료.
