# Site Audit Document: 17. 체험단모아 (모아뷰)

## 1. 개요 (Overview)
- **사이트명**: 17. 체험단모아 (모아뷰)
- **공식 도메인**: `https://moaview.co.kr`
- **주요 수집 대상**: 종합 마케팅 협찬 및 체험단 모아보기 플랫폼
- **연동 파이프라인**:
...
- **Target URL**: `https://moaview.co.kr`
- **HTTP Header 필수 조건**:
...
- **도메인 최신화**: 공식 도메인 `https://moaview.co.kr` 접속 상태 HTTP 200 OK 확인 완료.
