# Site Audit Document: 12. 에코블로그

## 1. 개요 (Overview)
- **사이트명**: 12. 에코블로그
- **공식 도메인**: `https://echoblog.net`
- **주요 수집 대상**: 친환경, 생활용품, 펫, 유아 특화 SNS 체험단 플랫폼
- **연동 파이프라인**:
...
- **도메인 최신화**: 공식 도메인 `https://echoblog.net` 접속 상태 HTTP 200 OK 확인 완료.
