...
현재 대상은 강남맛집, 디너의여왕, 포블로그, 리뷰노트, 체험뷰, 클라우드리뷰, 레뷰, 미블, 링블, 놀러와체험단, 모블, 아싸뷰입니다. 구형 링블·아싸뷰 URL을 쓰던 중복 모듈은 운영 경로에서 제거했습니다. 수집기가 원본 마감일을 제공하지 않는 공고는 임의 날짜를 만들지 않으며, 마지막 실수집 후 48시간 동안만 현재 목록으로 노출합니다.
