                  ...
                  <div>
                    <div className="keyword-master-summary-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '12px', marginBottom: '16px' }}>
                      ...
                      <div style={{ padding: '14px 18px', borderRadius: 'var(--radius-md)', backgroundColor: 'var(--bg-tertiary)', border: '1px solid var(--border-color)', display: 'flex', flexDirection: 'column', gap: '6px' }}>
                        ...
                        {activeKeywordGuideTooltip === 'volume' && (
                          <div style={{
                            ...
                            animation: 'fadeIn 0.15s ease-in-out', marginTop: '4px'
                          }}>
                      ...
                      <div style={{ padding: '14px 18px', borderRadius: 'var(--radius-md)', backgroundColor: keywordData.grade === 'GOLD' ? 'rgba(16, 185, 129, 0.08)' : keywordData.grade === 'NORMAL' ? 'rgba(245, 158, 11, 0.08)' : 'rgba(239, 68, 68, 0.08)', border: `1px solid ${keywordData.grade === 'GOLD' ? 'rgba(16, 185, 129, 0.3)' : keywordData.grade === 'NORMAL' ? 'rgba(245, 158, 11, 0.3)' : 'rgba(239, 68, 68, 0.3)'}`, display: 'flex', flexDirection: 'column', gap: '6px' }}>
                        ...
                        <div style={{ fontSize: '0.74rem', fontWeight: 700, color: keywordData.grade === 'GOLD' ? '#10b981' : keywordData.grade === 'NORMAL' ? '#d97706' : '#ef4444', whiteSpace: 'nowrap' }}>
      ...
      <footer style={{
        ...
        <div style={{ maxWidth: '1080px', margin: '0 auto', display: 'flex', flexDirection: 'column', gap: '16px', alignItems: 'center' }}>
          ...
          <p style={{ margin: '8px 0 0 0', fontSize: '0.76rem', color: 'var(--text-tertiary)', maxWidth: '840px', lineHeight: 1.5 }}>
            바이럴리는 정보 제공 애그리게이터 플랫폼으로서 각 플랫폼의 공개 체험단 정보를 수집하여 제공합니다. 각 캠페인의 모집, 당첨자 선정, 제품/서비스 혜택 지급 및 가이드라인의 책임은 해당 출처 사이트에 있으며, 원본 정보 및 썸네일 이미지에 대한 상표권과 저작권은 각 원작성자 및 제휴 제공처에 있습니다.
          </p>

          <p style={{ margin: 0, fontSize: '0.78rem', color: 'var(--text-tertiary)' }}>
            &copy; {new Date().getFullYear()} 바이럴리 (viral_re). All rights reserved.
          </p>
        </div>
      </footer>
        ...
        <div style={{
          ...
          <div className="glass-panel" style={{
            ...
            <div style={{ flex: 1, overflowY: 'auto', fontSize: '0.84rem', lineHeight: 1.6, color: 'var(--text-secondary)', paddingRight: '6px' }}>
              <p><strong>제1조 (목적)</strong><br />본 약관은 바이럴리(이하 "서비스")가 제공하는 체험단 정보 통합 검색 및 정보 제공 서비스의 이용조건 및 절차, 이용자와 서비스 간의 권리와 의무를 규정함을 목적으로 합니다.</p>
      ...
      {isPrivacyModalOpen && (
        <div style={{
          ...
          <div className="glass-panel" style={{
            ...
            <div style={{ flex: 1, overflowY: 'auto', fontSize: '0.84rem', lineHeight: 1.6, color: 'var(--text-secondary)', paddingRight: '6px' }}>
              <p>바이럴리(이하 "서비스")는 이용자의 개인정보보호를 매우 중요시하며, 「개인정보 보호법」 등 관련 법령을 준수합니다.</p>
      ...
      {isDisclaimerModalOpen && (
        <div style={{
          ...
          <div className="glass-panel" style={{
            ...
            <div style={{ flex: 1, overflowY: 'auto', fontSize: '0.84rem', lineHeight: 1.6, color: 'var(--text-secondary)', paddingRight: '6px' }}>
              <p><strong>1. 정보 제공 애그리게이터 면책</strong><br />바이럴리는 각 체험단 서비스의 공개 정보를 실시간 수집하여 모아보기 기능을 제공하는 애그리게이터 플랫폼입니다. 당사는 수집된 정보의 실시간 정확성이나 완전성을 보증하지 않습니다.</p>
              <p><strong>2. 캠페인 관련 계약 및 당첨 책의 면책</strong><br />체험단 신청, 당첨자 선정, 상품 및 혜택 지급의 의무는 해당 출처 중개 사이트 및 광고주에 있습니다. 바이럴리는 당사의 고의 또는 중과실이 없는 한 캠페인 신청 및 이용 과정에서 발생한 분쟁이나 손해에 대해 책임을 지지 않습니다.</p>
