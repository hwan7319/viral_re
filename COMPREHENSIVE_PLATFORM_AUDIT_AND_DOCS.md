...
### 🟢 Issue 22: 놀러와체험단(cometoplay.kr) 다중 카테고리 딥 수집 & 실감 HD 썸네일/신청인원 추출 100% 정상화 (2026-09-07)
* **증상**: 놀러와체험단 수집 데이터량이 ~45건에 불과했고, 썸네일에 노이즈 아이콘(`scrap_ic.png`, `txt_ico.png`)이 파싱되거나 지원 현황이 기본값(`0/5`)으로 표시됨.
* **원인 분석**:
...
* **기술적 조치**:
  1) 놀러와체험단 카테고리 ID (`001`, `002`, `004`, `001012`, `001013`, `001015`, `002010`, `002008`) 및 1~5페이지 순회 알고리즘을 도입하여 데이터량을 **364건**으로 확대 수집함.
